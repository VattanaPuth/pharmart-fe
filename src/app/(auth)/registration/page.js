      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 w-full max-w-md">
        ...
        <div className="space-y-4">
          ...
          {/* <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-slate-200 rounded-lg font-medium text-slate-700 hover:bg-slate-50 transition-colors"
          >
            <FcGoogle size={18} cxlassName="text-red-500" />
          ...
          <GoogleLogin
            ...
            onError={() => {
              toast.log("Registration With Google Failed");
            }}
          />
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span>Register with Phone (OTP)</span>
            </div>
            <svg
